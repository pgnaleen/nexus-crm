  ...
  return (
    <div className="mb-[18px]">
      ...
      <input
        ...
        name={name}
        className={[
          "w-full rounded-lg border bg-white px-3 py-2.5 text-sm text-crm-text transition-colors duration-150 read-only:cursor-default read-only:bg-[var(--color-bg)] read-only:text-[var(--color-text-muted)] read-only:shadow-none focus:outline-none focus:shadow-[0_0_0_3px_rgba(233,28,45,0.15)]",
