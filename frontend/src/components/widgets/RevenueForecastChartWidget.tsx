...
const DUMMY_DATA = [
  { month: "Aug", actual: 300000, projected: 300000 },
  { month: "Sep", actual: 450000, projected: 450000 },
  { month: "Oct", actual: null, projected: 550000 },
  { month: "Nov", actual: null, projected: 850000 },
  { month: "Dec", actual: null, projected: 1200000 },
];
...
export function RevenueForecastChartWidget() {
  return (
    <div className="group relative flex h-full flex-col overflow-hidden rounded-xl bg-white p-5 shadow-[0_1.5px_4px_rgba(15,23,42,0.04)] border border-slate-100 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_8px_20px_rgba(15,23,42,0.08)] hover:border-slate-200/80">
      ...
      <div className="flex-1 min-h-[200px]">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={DUMMY_DATA} margin={{ top: 4, right: 8, left: 10, bottom: 0 }}>
            <defs>
