...
import { DealRegistrationIcon } from "@/components/ui/icons";
...
export default async function DealRegistrationPage({ params }: { params: { tenant: string } }) {
  ...
  return (
    <ComingSoonSection
      title={t("dealRegistration.title")}
      subtitle={t("dealRegistration.subtitle")}
      icon={<DealRegistrationIcon size={22} />}
    />
  );
}
