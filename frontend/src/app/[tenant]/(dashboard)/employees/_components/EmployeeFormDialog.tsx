...
import { CheckCircleIcon, UploadCloudIcon, UsersGroupIcon, UserIcon } from "@/components/ui/icons";
...
export function EmployeeFormDialog({
  ...
  const dialogTitle = postSaveState ? (
    ...
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col min-w-0">
        <span className="text-[15px] font-bold text-crm-text truncate">
          {isEditMode ? t("employees.dialog.editTitle") : t("employees.dialog.addTitle")}
        </span>
        {isEditMode && employee && (
      ...
      <form onSubmit={handleSubmit}>
        {(() => {
          const tabsOrder: TabId[] = [
            ...
            "employment",
            "contact",
            ...(canViewSensitive ? (["confidential"] as TabId[]) : []),
            ...(showAccountTab ? (["account"] as TabId[]) : []),
          ];
          const TAB_ICONS: Record<TabId, React.ReactNode> = {
            ...
            account: <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.2} d="M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18" /></svg>,
          };
          const TAB_LABELS: Record<TabId, string> = {
            ...
            account: t("employees.dialog.tabs.account"),
          };
          return (
