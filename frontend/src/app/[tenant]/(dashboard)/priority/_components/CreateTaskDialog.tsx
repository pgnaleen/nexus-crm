  ...
  const dialogTitle = (
    <div className="flex items-center gap-3">
      ...
      <div className="flex flex-col min-w-0">
        <span className="text-[15px] font-bold text-crm-text truncate">{t("priorityTracker.dialog.title")}</span>
      </div>
    </div>
  );

  return (
    <Dialog open title={dialogTitle} onClose={onClose} maxWidth="480px">
