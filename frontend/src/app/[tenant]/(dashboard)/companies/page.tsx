  ...
  return (
    <div className="flex flex-col">
      <div className="mb-6 flex items-center justify-between">
        <div className="flex flex-col">
          <h1 className="m-0 mb-0.5 text-[26px] font-bold text-crm-text">Companies</h1>
          <p className="m-0 text-[13.5px] text-[var(--color-text-muted)]">Manage client organizations and accounts</p>
        </div>
        <button
          type="button"
