...
- Update `docs/project/api-endpoint-registry.md` in the same change.
...
- `CLAUDE.md`, `docs/project/feature-development-guideline.md` — record the
  one-permission exception
- `docs/project/api-endpoint-registry.md` — the three new endpoints
